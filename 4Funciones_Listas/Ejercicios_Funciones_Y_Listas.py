...
if op == 1:
    Funciones_de_Ejercicios.U_Mexico(nombres, edades, mails, telefonos, country)

elif op == 2:
    Funciones_de_Ejercicios.U_Brasil(nombres, mails, telefonos, country)

elif op == 3:
    Funciones_de_Ejercicios.mas_joven(nombres, edades)

elif op == 4:
    Funciones_de_Ejercicios.promedio_edades(edades)

elif op == 5:
    Funciones_de_Ejercicios.mayor_brasil(nombres, edades, country, mails, telefonos, address, postalZip, region)

elif op == 6:
    Funciones_de_Ejercicios.mexico_brasil_cp(nombres, country, postalZip)

elif op == 7:
    Funciones_de_Ejercicios.italianos_mayores(nombres, mails, telefonos, country, edades)
